...
enum PerfFormat {
  ...
  SPT = 4,                 // Intel Processor Trace (SPT) file.
...
*/
class SPTPerfReader : public PerfReaderBase {
public:
  SPTPerfReader(ProfiledBinary *Binary, StringRef SPTTrace)
      : PerfReaderBase(Binary, SPTTrace){};
  
  // Entry point to parse SPT traces
  void parsePerfTraces() override;
